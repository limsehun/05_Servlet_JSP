...
public class TestServlet extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		// 전달 받은 값을  h1태그의 각각 다른 색상으로 출력되도록 HTML코드를 작성하여 응답하기
...
//		req.getParameter("input1")
		...
		/* 응답 처리 */
		// -> Servlet이 직접 HTML 코드를 작성하지 않고  JSP한테 대신 화면을 만들어 클라이언트에게 응답(출력)하라고 요청을 떠넘기자
		//		-> 요청 위임
		...
		// 요청 위임 방법 2)
		// 요청을 전달 할 객체(RequestDispatcher) 얻어오기
