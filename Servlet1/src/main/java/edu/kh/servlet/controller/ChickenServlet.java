...
public class ChickenServlet extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		// -> 제출된 값중 name속성이 일치하는 것을 모두모아 하나의 String[]로 반환
		
		// 단, name속성 값이 일치하는게 없는 경우 "null" 반환
		
		String[] options = req.getParameterValues("opt");
		
		//--------------------------------------------------------------------------
		
		/* 선택한 치킨, 뼈/순살, 옵션에 따라 가객 책정하기 */
		...
		if(type.equals("bornless")) price += 2000;
